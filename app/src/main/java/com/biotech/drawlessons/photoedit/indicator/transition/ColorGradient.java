...
public class ColorGradient {
	...
	private int color1Light;
	private int color2Light;
	private int color1Night;
	private int color2Night;


	public ColorGradient(int color1Light, int color2Light, int color1Night , int color2Night, int count) {
		super();
		this.color1Light=color1Light;
		this.color2Light=color2Light;
		this.color1Night = color1Night;
		this.color2Night = color2Night;
		applyTheme();
		this.count =  count;
	}

	public void applyTheme(){
		this.color1 = color1Light;
		this.color2 = color2Light;
